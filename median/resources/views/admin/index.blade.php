...
<div class="container" id="wrapper">
	...
	<section id="admin_users">
		<h5 class="header-title text-primary">
			...
			<a href="#articles" role="button" class="btn text-white" style="background-color: DarkSalmon">Articles</a>
		</h5>
	...
	<h5 class="header-title text-danger">
		...
		<a href="#users" role="button" class="btn bg-primary text-white">Users</a>
	</h5>
